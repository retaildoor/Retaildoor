...
$(function() {
    ...
    require(
        ...
        function (ec, limitless) {
            ...
            var basic_lines1 = ec.init(document.getElementById('basic_lines1'),limitless);
                ...
                series: [
                    {
                        name: '2014',
                        type: 'line',
                        data: [514850,494483,457128,507560,495370,939348,796602,830766,800790,885403,978258,859382],
                        markLine: {
                            data: [{
                                type: 'average',
                                name: 'Average Sales 2014'
                            }]
                        }
                    },
                    {
                        name: '2015',
                        type: 'line',
                        data: [817427,788802,826210,841562,818243,642777,798346,657360,829290,809016,827356,677854],
                        markLine: {
                            data: [{
                                type: 'average',
                                name: 'Average Sales 2015'
                            }]
                        }
                    }
                ]
                ...
                series: [
                    {
                        name: '2014',
                        type: 'line',
                        data: [263,103,807,718,534,929,186,357,871,304,254,696],
                        markLine: {
                            data: [{
                                type: 'average',
                                name: 'Average Traffic 2014'
                            }]
                        }
                    },
                    {
                        name: '2015',
                        type: 'line',
                        data: [652,83,992,357,61,177,707,245,997,744,992,425],
                        markLine: {
                            data: [{
                                type: 'average',
                                name: 'Average Traffic 2015'
                            }]
                        }
                    }
                ]
            ...
            basic_lines1.setOption(basic_lines1_options);
