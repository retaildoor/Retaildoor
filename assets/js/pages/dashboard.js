...
$(function() {    
    ...
    sparkline("#server-load", "area", 30, 128, "basis", 750, 2000, "rgba(255,255,255,0.5)");
    ...
    dailyRevenue('#today-revenue', 128); // initialize chart
    ...
    generateBarChart("#door", 24, 95, true, "elastic", 1200, 50, "rgba(255,255,255,0.5)", "Door");
    generateBarChart1("#door1", 24, 95, true, "elastic", 1200, 50, "rgba(255,255,255,0.5)", "Door");
    generateBarChart2("#this-year", 12, 25, true, "elastic", 1200, 30, "rgba(255,255,255,0.5)", "Door");
    generateBarChart3("#last-year", 12, 25, true, "elastic", 1200, 30, "rgba(255,255,255,0.5)", "Door");
    ...
    function generateBarChart(element, barQty, height, animate, easing, duration, delay, color, tooltip) {
        ...
        var bardata1 = [];
            bardata1.push(825573,919474,702121,868357,1134511,919160,1152889,1095396,1098461,928197,1207743,1025699,1004197,889948,929907,1083570,1104064,856749,1179091,990148,1037176,1124263,839507,892562)
     
        var bardata2 = [];
            bardata2.push('JAN-2014','FEB-2014','MAR-2014','APR-2014','MAY-2014','JUN-2014','JUL-2014','AUG-2014','SEP-2014','OCT-2014','NOV-2014','DEC-2014','JAN-2015','FEB-2015','MAR-2015','APR-2015','MAY-2015','JUN-2015','JUL-2015','AUG-2015','SEP-2015','OCT-2015','NOV-2015','DEC-2015')
        // Main variables
        var d3Container = d3.select(element),
        ...
        // Horizontal
        x.domain(d3.range(0, bardata1.length))

        // Vertical
        y.domain([0, d3.max(bardata1)])
        ...
        // Show and hide
        if(tooltip == "hours" || tooltip == "goal" || tooltip == "Door") {
            bars.call(tip)
        ...
        if(tooltip == "Door") {
            tip.html(function (d, i) {
                ...
                return "<div class='text-center'>" +
                        "<h6 class='no-margin'><span class='text-size-small'>Sales : </span> $"+ d + "</h6>" +
                        "<div class='text-size-small'>" + bardata2[i] + "</div>" +
                        "</div>"
            });
        }
    ...
    function generateBarChart1(element, barQty, height, animate, easing, duration, delay, color, tooltip) {
        ...
        var bardata1 = [];
            bardata1.push(1053854,853270,775821,753568,1167575,868482,990453,838723,957697,960875,1006410,1129580,748478,929873,845647,884279,958754,782253,947313,873839,769425,1126905,917643,794728)
    ...
    function generateBarChart2(element, barQty, height, animate, easing, duration, delay, color, tooltip) {
        ...
        var bardata1 = [];
            bardata1.push(1004197,889948,929907,1083570,1104064,856749,1179091,990148,1037176,1124263,839507,892562)
     
        var bardata2 = [];
            bardata2.push('JAN-2015','FEB-2015','MAR-2015','APR-2015','MAY-2015','JUN-2015','JUL-2015','AUG-2015','SEP-2015','OCT-2015','NOV-2015','DEC-2015')
        // Main variables
        var d3Container = d3.select(element),
            width = d3Container.node().getBoundingClientRect().width;
    ...
    function generateBarChart3(element, barQty, height, animate, easing, duration, delay, color, tooltip) {
        ...
        var bardata1 = [];
            bardata1.push(825573,919474,702121,868357,1134511,919160,1152889,1095396,1098461,928197,1207743,1025699)
     
        var bardata2 = [];
            bardata2.push('JAN-2014','FEB-2014','MAR-2014','APR-2014','MAY-2014','JUN-2014','JUL-2014','AUG-2014','SEP-2014','OCT-2014','NOV-2014','DEC-2014')
        // Main variables
        var d3Container = d3.select(element),
            width = d3Container.node().getBoundingClientRect().width;
